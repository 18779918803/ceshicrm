    ...
    <table style="padding: 5px" width="100%">
        <tr>
            ...
            <td valign="bottom" align="right" width="50%">
                <font size="3">&nbsp;&nbsp;<strong>欢迎：</strong><span id="userInfo">${userName!"xxx"}|【${trueName!"xxx" }】</span></font>
            </td>
        </tr>
    </table>
</div>
...
<div region="west" style="width: 200px" title="导航菜单" split="true">
    ...
    <#if userPermission?seq_contains('60')>
        <div title="系统管理"  data-options="iconCls:'icon-item'" style="padding:10px">
            ...
            <a href="javascript:openTab('角色管理','user/index','icon-user')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-user'" style="width: 150px;">用户信息管理</a>
            <a href="javascript:openTab('用户信息管理','role/index','icon-user')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-user'" style="width: 150px;">角色管理</a>
